...
while True:
  cd = os.getcwd()
  command = input(Back.WHITE + Fore.BLACK + " PYSH " + Style.RESET_ALL + " " + cd + " > " + Fore.CYAN)
  ...
  if command == "print" or command == "print ":
    ...
    license = tk.Label(text=open(cd2 + "/LICENSE", "r").read())
    license.pack()
  elif command == "cls":
    # thanks stack overflow
    os.system('cls' if os.name=='nt' else 'clear')
